...
export class BlockController {
  ...
  public async getAll(@Body() filter: SearchFilter<BlockFilterDto>, @Req() req): Promise<ResponseFilter<BlockModel[]>> {
  ...
  @Post("/super/all")
  @HttpCode(ResponseStatus.SUCCESS)
  public async superGetAll(@Body() filter: SearchFilter<BlockFilterDto>): Promise<ResponseFilter<BlockModel[]>> {
    return ResponseFilter.response<BlockModel[]>(await this.blockProvider.getAll(filter.filters), ResponseStatus.SUCCESS);
  }
  ...
  public async createBlockToken(@Body("blockId") blockId: number, @Body("week") week: number, @Req() req): Promise<ResponseFilter<string>> {
    return ResponseFilter.response<string>(await this.blockProvider.createBlockHash(blockId, week, req.user.companyId), ResponseStatus.CREATED);
  }

  @UseGuards(SuperAdminGuard)
  @Post("/super/hash")
  @HttpCode(ResponseStatus.CREATED)
  public async superCreateBlockToken(@Body("blockId") blockId: number, @Body("week") week: number): Promise<ResponseFilter<string>> {
  ...
  @Get(":blockId")
  @HttpCode(ResponseStatus.SUCCESS)
  public async getOne(@Param("blockId") blockId: number, @Req() req): Promise<ResponseFilter<BlockModel>> {
    return ResponseFilter.response<BlockModel>(await this.blockProvider.getOne(blockId, null, req.user.companyId), ResponseStatus.SUCCESS);
  }

  @UseGuards(SuperAdminGuard)
  @Get("/super/:blockId")
  @HttpCode(ResponseStatus.SUCCESS)
  public async superGetOne(@Param("blockId") blockId: number): Promise<ResponseFilter<BlockModel>> {
  ...
  public async remove(@Body("blocks") blocks: number[], @Req() req): Promise<ResponseFilter<null>> {
  ...
  @Delete("/super")
  @HttpCode(ResponseStatus.NO_CONTENT)
  public async superRemove(@Body("blocks") blocks: number[]): Promise<ResponseFilter<null>> {
  ...
  @Patch(":blockId")
  @HttpCode(ResponseStatus.SUCCESS)
  public async update(@Param("blockId") blockId: number, @Body() updateDto: BlockUpdateDto, @Req() req): Promise<ResponseFilter<BlockModel>> {
    return ResponseFilter.response<BlockModel>(await this.blockProvider.update(blockId, updateDto, req.user.companyId), ResponseStatus.SUCCESS);
  }

  @UseGuards(SuperAdminGuard)
  @Patch("/super/:blockId")
  @HttpCode(ResponseStatus.SUCCESS)
  public async updateSuper(@Param("blockId") blockId: number, @Body() updateDto: BlockUpdateDto, @Req() req): Promise<ResponseFilter<BlockModel>> {
    return ResponseFilter.response<BlockModel>(await this.blockProvider.update(blockId, updateDto, null), ResponseStatus.SUCCESS);
  }
  ...
  public async saveStat(
    ...
    return ResponseFilter.response<BlockGroupStatOutputDto[]>(await this.blockProvider.saveStat(blockId, week, req.user.companyId), ResponseStatus.SUCCESS);
  }
  ...
  public async saveStatByGroup(
    ...
    return ResponseFilter.response<BlockGroupStatOutputDto[]>(await this.blockProvider.saveStat(blockId, week, req.user.companyId, groupId), ResponseStatus.SUCCESS)
  }
  ...
  public async superSaveStatByGroup(
    ...
    return ResponseFilter.response<BlockGroupStatOutputDto[]>(await this.blockProvider.saveStat(blockId, week, null, groupId), ResponseStatus.SUCCESS)
  }
  ...
  public async saveStatSpecialIds(
    ...
    return ResponseFilter.response<BlockGroupStatOutputDto[]>(await this.blockProvider.saveStat(blockId, week, req.user.companyId, groupId, resultIds), ResponseStatus.SUCCESS)
  }
  ...
  public async superSaveStatSpecialIds(
    ...
    return ResponseFilter.response<BlockGroupStatOutputDto[]>(await this.blockProvider.saveStat(blockId, week, null, groupId, resultIds), ResponseStatus.SUCCESS)
  }
}
